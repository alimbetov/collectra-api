...
| POST | `/api/v1/integration/service-clients` | User | `SERVICE_CLIENT_CREATE` |
| POST | `/api/v1/integration/service-clients/{id}/rotate-secret` | User | `SERVICE_CLIENT_ROTATE_SECRET` |

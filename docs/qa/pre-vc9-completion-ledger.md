...
| T30-30 | top-30-smoke-contracts.md | cross-persona/system | integration -> finance -> collections -> campaign -> outbox/Rabbit -> delivery | least privilege by checkpoint | Alpha/Beta probes required | RabbitMqMessageDeliverySmokeIntegrationTest + FunctionalHardeningSecuritySmokeIntegrationTest | TESTED | a3dbd65bc20156eb044d6edea2485edde8f45401 / run 36238480310; composite chain passes, final verification SHA still required | D13; WP-12 |

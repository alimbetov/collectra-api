...
Implementation companions are mandatory:
- `docs/qa/pre-vc9-remediation-code-level-guide.md` for code-level patterns, current-code anchors and forbidden shortcuts;
- `docs/qa/pre-vc9-wp-architecture-review.md` for high-value WP improvements and dependencies;
- `docs/qa/wp-definition-of-done.md` for mandatory WP completion semantics.

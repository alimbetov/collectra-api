...
public class ImportBatch extends AuditableEntity {
    ...
    @Column(name = "mapping_profile_version_id", nullable = false)
    private UUID mappingProfileVersionId;
    ...
    @Column(nullable = false, length = 30)
    private String source = "LEGACY_IMPORT";

    @Column(name = "source_schema_version_id")
    private UUID sourceSchemaVersionId;

    @Column(name = "raw_source_file_id")
    private UUID rawSourceFileId;

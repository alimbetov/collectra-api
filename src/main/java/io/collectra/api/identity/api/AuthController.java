...
public class AuthController {
    ...
    @PostMapping("/login/by-slug") AuthService.AuthTokens loginBySlug(@Valid @RequestBody SlugLoginRequest r){return auth.login(r.tenantSlug(),r.email(),r.password());}
    ...
    public record SlugLoginRequest(@Pattern(regexp="[a-z0-9-]{3,80}") String tenantSlug,@Email @NotBlank String email,@NotBlank String password){}

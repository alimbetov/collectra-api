...
export function CollectionsPage(){
 ...
 const q=useQuery({...collectionQueries.list({...(status?{status}:{}),...(priority?{priority}:{}),page,size,sort:p.get('sort')??'createdAt,desc'}),placeholderData:keepPreviousData});

...
describe('CollectionsPage',()=>{
 ...
 it('routes authorization failures to forbidden',async()=>{vi.mocked(getCollectionCases).mockRejectedValue(new ApiError(403,{status:403}));renderPage();await waitFor(()=>expect(screen.getByTestId('location')).toHaveTextContent('/forbidden'))});
});
